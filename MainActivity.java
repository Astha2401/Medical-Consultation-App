...
ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(this, drawer, t,
...
browserIntent.setData(Uri.parse("https://www.google.com/maps/sea
rch/hospitals+near+me"));
startActivity(browserIntent);
break;
case R.id.nav_cntus:
Intent c_us = new Intent(MainActivity.this,
activity_contact_us.class);
startActivity(c_us);
break;
}
